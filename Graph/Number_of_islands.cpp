...
//         for(int i = 0; i < n; i++){
//             for(int j = 0; j < m; j++){
//                 // Start a new BFS when an unvisited land cell is found
//                if(grid[i][j] == 'L' && !vis[i][j]){
//                    islands++;
//                    bfs(i, j, grid, vis);
//                }
...
/* Leetcode  Submission    (200. Number of Islands) */
...
//         // connected component. The task is to find no. of disconnected components in the graph.
